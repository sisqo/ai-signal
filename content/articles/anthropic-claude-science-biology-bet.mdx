...
On June 30, Anthropic put out a beta of something called [Claude Science](https://www.anthropic.com/news/claude-science-ai-workbench) and mostly talked about it the way it talks about everything: workbench, artifacts, reproducibility. Ten days earlier, on June 19, John Jumper — the man who shared a Nobel Prize for solving protein folding — announced [on X](https://x.com/JohnJumperSci/status/2068001285173834106) that he was leaving Google DeepMind for Anthropic after almost nine years. Read those two events separately and they're both mid-tier tech news. Read them together and they're the same announcement, made twice.
